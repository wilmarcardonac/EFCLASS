...
int background_functions(
  ...
  if (pba->has_lambda == _TRUE_)
      ...
      if (pba->has_fR == _TRUE_)
	{
	  if (pba->alpha_fR != 0.)
	    {
	      /* w(a) */
	      /* 1st order in terms of b */
	      pvecback[pba->index_bg_w_fR] = -1 + (pba->alpha_fR*pow(a,-1)*(208*om0*or0*(-1 + om0 + or0)*pow(a,3) - 8*or0*pow(om0,2) + 168*(-1 + om0 + or0)*pow(a,4)*pow(om0,2) - 3*a*pow(om0,3) - 128*or0*pow(a,6)*pow(-1 + om0 + or0,2) - 192*om0*pow(a,7)*pow(-1 + om0 + or0,2))*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-3))/3.;
	      //-1 + (pba->alpha_fR*(-3*a*pow(om0,3) - 8*pow(om0,2)*or0 + 168*pow(a,4)*pow(om0,2)*(-1 + om0 + or0) + 208*pow(a,3)*om0*or0*(-1 + om0 + or0) - 192*pow(a,7)*om0*pow(-1 + om0 + or0,2) - 128*pow(a,6)*or0*pow(-1 + om0 + or0,2)))/(3.*a*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) ;

	      /* rho DE in terms of b */
	      pvecback[pba->index_bg_rho_lambda] = (-1 + om0 + or0)*pow(pba->H0,2)*(-1 + pba->alpha_fR*pow(a,-1)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),-2)*(-8*om0*or0 + 8*or0*(-1 + om0 + or0)*pow(a,3) + 8*om0*(-1 + om0 + or0)*pow(a,4) - 7*a*pow(om0,2) + 8*pow(a,7)*pow(-1 + om0 + or0,2) + a*log(-(pba->mu2_fR*pow(a,3)*pow(pba->H0,-2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1))/3.)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),2)));
	      
	      //pow(pba->H0,2)*(-1 + om0 + or0)*(-1 + (pba->alpha_fR*(-7*a*pow(om0,2) - 8*om0*or0 + 8*pow(a,4)*om0*(-1 + om0 + or0) + 8*pow(a,3)*or0*(-1 + om0 + or0) + 8*pow(a,7)*pow(-1 + om0 + or0,2) + a*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(a*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2))) ;
	  ...
	  if (pba->bhs != 0.)
	    {
	      ...
	      /* 1st order in terms of b*/
	      pvecback[pba->index_bg_rho_lambda] = pow(pba->H0,2)*(-1 + om0 + or0)*(-1 + (2*pow(a,2)*pba->bhs*(-1 + om0 + or0)*(-6*a*pow(om0,2) - 7*om0*or0 + 3*pow(a,4)*om0*(-1 + om0 + or0) + 4*pow(a,3)*or0*(-1 + om0 + or0) + 12*pow(a,7)*pow(-1 + om0 + or0,2)))/pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3));

	      /* 2nd order in terms of b*/
	      //pvecback[pba->index_bg_rho_lambda] = ((1-om0-or0+(2*pow(a,2)*pba->bhs*pow(-1+om0+or0,2)*(-6*a*pow(om0,2)-7*om0*or0+3*pow(a,4)*om0*(-1+om0+or0)+4*pow(a,3)*or0*(-1+om0+or0)+12*pow(a,7)*pow(-1+om0+or0,2)))/pow(-om0+4*pow(a,3)*(-1+om0+or0),3)-(pow(a,5)*pow(pba->bhs,2)*pow(-1+om0+or0,3)*(-37*a*pow(om0,6)-40*pow(om0,5)*or0+4656*pow(a,4)*pow(om0,5)*(-1+om0+or0)+8692*pow(a,3)*pow(om0,4)*or0*(-1+om0+or0)+4032*pow(a,2)*pow(om0,3)*pow(or0,2)*(-1+om0+or0)+7452*pow(a,7)*pow(om0,4)*pow(-1+om0+or0,2)+25728*pow(a,6)*pow(om0,3)*or0*pow(-1+om0+or0,2)+17856*pow(a,5)*pow(om0,2)*pow(or0,2)*pow(-1+om0+or0,2)-25408*pow(a,10)*pow(om0,3)*pow(-1+om0+or0,3)-22016*pow(a,9)*pow(om0,2)*or0*pow(-1+om0+or0,3)+9216*pow(a,8)*om0*pow(or0,2)*pow(-1+om0+or0,3)+22848*pow(a,13)*pow(om0,2)*pow(-1+om0+or0,4)+2048*pow(a,12)*om0*or0*pow(-1+om0+or0,4)-9216*pow(a,16)*om0*pow(-1+om0+or0,5)-3072*pow(a,15)*or0*pow(-1+om0+or0,5)-1024*pow(a,19)*pow(-1+om0+or0,6)))/pow(om0-4*pow(a,3)*(-1+om0+or0),8))/(1-om0-or0))*pow(pba->H0,2)*pba->Omega0_lambda;
  ...
  if (pba->has_fR == _TRUE_) 
      ...
      if (pba->b_pi != 0.)
	{
      ...
      if (pba->alpha_fR != 0.)
	{
	  /* FR 2nd order in terms of alpha_fR */
	  pvecback[pba->index_bg_FR_fR] = (-2*pba->alpha_fR*(-1 + om0 + or0)*pow(a,6)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),-2))/3. + (2*(-1 + om0 + or0)*pow(a,6)*pow(pba->alpha_fR,2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-3)*(log(6)*(om0 - 4*(-1 + om0 + or0)*pow(a,3)) - pow(a,-8)*(-om0 + 4*(-1 + om0 + or0)*pow(a,3))*pow(1 + or0*(-1 + pow(a,-4)) + om0*(-1 + pow(a,-3)),-1)*(-(log(-2*pba->mu2_fR*pow(a,3)*pow(pba->H0,-2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1))*pow(a,4)*(-(a*om0) - or0 + (-1 + om0 + or0)*pow(a,4))) + (log(36) + log(-(pba->mu2_fR*pow(a,3)*pow(pba->H0,-2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1))/3.))*pow(a,4)*(-(a*om0) - or0 + (-1 + om0 + or0)*pow(a,4)) + (-1 + om0 + or0)*pow(4 - 4*or0 + om0*(-4 + pow(a,-3)),-2)*(16*a*om0*or0 + 8*or0*(-1 + om0 + or0)*pow(a,4) + 9*pow(a,2)*pow(om0,2) + 8*pow(or0,2) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),2) - log(-(pba->mu2_fR*pow(a,3)*pow(pba->H0,-2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1))/3.)*pow(a,2)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),2) + 8*pow(a*om0 + or0 - (-1 + om0 + or0)*pow(a,4),2))) + (-1 + om0 + or0)*pow(a,2)*((-416*om0*or0*(-1 + om0 + or0)*pow(a,3) + 16*or0*pow(om0,2) - 336*(-1 + om0 + or0)*pow(a,4)*pow(om0,2) + 6*a*pow(om0,3) + 256*or0*pow(a,6)*pow(-1 + om0 + or0,2) + 384*om0*pow(a,7)*pow(-1 + om0 + or0,2))*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-3) + 4*pow(a,-7)*pow(4 - 4*or0 + om0*(-4 + pow(a,-3)),-2)*(16*a*om0*or0 + 8*or0*(-1 + om0 + or0)*pow(a,4) + 9*pow(a,2)*pow(om0,2) + 8*pow(or0,2) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),2) - log(-(pba->mu2_fR*pow(a,3)*pow(pba->H0,-2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1))/3.)*pow(a,2)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),2) + 8*pow(a*om0 + or0 - (-1 + om0 + or0)*pow(a,4),2)) + (3*a*om0 + 4*or0)*pow(a,-11)*pow(4 - 4*or0 + om0*(-4 + pow(a,-3)),-2)*pow(1 + or0*(-1 + pow(a,-4)) + om0*(-1 + pow(a,-3)),-1)*(16*a*om0*or0 + 8*or0*(-1 + om0 + or0)*pow(a,4) + 9*pow(a,2)*pow(om0,2) + 8*pow(or0,2) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),2) - log(-(pba->mu2_fR*pow(a,3)*pow(pba->H0,-2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1))/3.)*pow(a,2)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),2) + 8*pow(a*om0 + or0 - (-1 + om0 + or0)*pow(a,4),2)))))/3.;

	  /* F 2nd order in terms of alpha_fR */
	  pvecback[pba->index_bg_F_fR] = 1 - 2*pba->alpha_fR*(-1 + om0 + or0)*pow(a,3)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1) - 2*(1 - om0 - or0)*pow(a,3)*pow(pba->alpha_fR,2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1)*(log(2) - log((-2*pba->mu2_fR*pow(a,3)*pow(pba->H0,-2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1))/3.) + log(-(pba->mu2_fR*pow(a,3)*pow(pba->H0,-2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1))/3.) + (-1 + om0 + or0)*pow(a,2)*(-208*om0*or0*(-1 + om0 + or0)*pow(a,3) + 8*or0*pow(om0,2) - 168*(-1 + om0 + or0)*pow(a,4)*pow(om0,2) + 3*a*pow(om0,3) + 128*or0*pow(a,6)*pow(-1 + om0 + or0,2) + 192*om0*pow(a,7)*pow(-1 + om0 + or0,2))*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),-4) + 4*(-1 + om0 + or0)*pow(a,-5)*pow(4 - 4*or0 + om0*(-4 + pow(a,-3)),-2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1)*(16*a*om0*or0 + 8*or0*(-1 + om0 + or0)*pow(a,4) + 9*pow(a,2)*pow(om0,2) + 8*pow(or0,2) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),2) - log(-(pba->mu2_fR*pow(a,3)*pow(pba->H0,-2)*pow(-om0 + 4*(-1 + om0 + or0)*pow(a,3),-1))/3.)*pow(a,2)*pow(om0 - 4*(-1 + om0 + or0)*pow(a,3),2) + 8*pow(a*om0 + or0 - (-1 + om0 + or0)*pow(a,4),2)));
 
	  /* Fprime 2nd order in terms of alpha*/
      ...
      else
	{
	  /* FR */
	  /* 2nd order in terms of b*/
	  pvecback[pba->index_bg_FR_fR] = (-4*pow(a,9)*pba->bhs*pow(-1 + om0 + or0,2))/(3.*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) - (4*pow(a,12)*pow(pba->bhs,2)*pow(-1 + om0 + or0,3)*(-pow(om0,4) + 100*pow(a,3)*pow(om0,3)*(-1 + om0 + or0) + 84*pow(a,2)*pow(om0,2)*or0*(-1 + om0 + or0) - 60*pow(a,6)*pow(om0,2)*pow(-1 + om0 + or0,2) + 96*pow(a,5)*om0*or0*pow(-1 + om0 + or0,2) - 32*pow(a,9)*om0*pow(-1 + om0 + or0,3) + 128*pow(a,12)*pow(-1 + om0 + or0,4)))/pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),8);
	  ...
	  /* F */
	  /* 2nd order in terms of b*/
	  pvecback[pba->index_bg_F_fR] = 1 - (2*pow(a,6)*pba->bhs*pow(-1 + om0 + or0,2))/pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) - (4*pow(a,9)*pow(pba->bhs,2)*pow(-1 + om0 + or0,3)*(-pow(om0,4) + 100*pow(a,3)*pow(om0,3)*(-1 + om0 + or0) + 84*pow(a,2)*pow(om0,2)*or0*(-1 + om0 + or0) - 60*pow(a,6)*pow(om0,2)*pow(-1 + om0 + or0,2) + 96*pow(a,5)*om0*or0*pow(-1 + om0 + or0,2) - 32*pow(a,9)*om0*pow(-1 + om0 + or0,3) + 128*pow(a,12)*pow(-1 + om0 + or0,4)))/pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),7);
	  ...
	  /* Fprime */
	  /* 2nd order in terms of b*/
	  pvecback[pba->index_bg_Fprime_fR] = (12*pow(a,7)*pba->bhs*om0*pow(-1 + om0 + or0,2)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0))/pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3) - (12*pow(a,10)*pow(pba->bhs,2)*om0*pow(-1 + om0 + or0,3)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)*(3*a*pow(om0,5) + 3*pow(om0,4)*or0 - 381*pow(a,4)*pow(om0,4)*(-1 + om0 + or0) - 685*pow(a,3)*pow(om0,3)*or0*(-1 + om0 + or0) - 308*pow(a,2)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) - 567*pow(a,7)*pow(om0,3)*pow(-1 + om0 + or0,2) - 2220*pow(a,6)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) - 1568*pow(a,5)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) + 1680*pow(a,10)*pow(om0,2)*pow(-1 + om0 + or0,3) + 1488*pow(a,9)*om0*or0*pow(-1 + om0 + or0,3) - 896*pow(a,8)*pow(or0,2)*pow(-1 + om0 + or0,3) - 1392*pow(a,13)*om0*pow(-1 + om0 + or0,4) + 64*pow(a,12)*or0*pow(-1 + om0 + or0,4) + 576*pow(a,16)*pow(-1 + om0 + or0,5)))/(pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),8)*(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0)));
	  
	  /* Full expression does not work: core dumped problem */
	  //pvecback[pba->index_bg_Fprime_fR] = ;
