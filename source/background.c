  ...
  if (pba->has_lambda == _TRUE_)
      ...
      if (pba->has_fR == _TRUE_)
	{
	  if (pba->alpha_fR != 0.)
	    {
	      /* w(a) */
	      pvecback[pba->index_bg_w_fR] = -1 + (pba->alpha_fR*(-3*a*pow(om0,3) - 8*pow(om0,2)*or0 + 168*pow(a,4)*pow(om0,2)*(-1 + om0 + or0) + 208*pow(a,3)*om0*or0*(-1 + om0 + or0) - 192*pow(a,7)*om0*pow(-1 + om0 + or0,2) - 128*pow(a,6)*or0*pow(-1 + om0 + or0,2)))/(3.*a*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) ;

	      pvecback[pba->index_bg_rho_lambda] = pow(pba->H0,2)*(-1 + om0 + or0)*(-1 + (pba->alpha_fR*(-7*a*pow(om0,2) - 8*om0*or0 + 8*pow(a,4)*om0*(-1 + om0 + or0) + 8*pow(a,3)*or0*(-1 + om0 + or0) + 8*pow(a,7)*pow(-1 + om0 + or0,2) + a*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(a*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2))) ;
  ...
  if (pba->has_fR == _TRUE_) 
    {
      if (pba->b_pi != 0.)
	{
	  pvecback[pba->index_bg_Fprime_fR] = 0.;//((pow(a,2.+3.*des_c0)*(7.+6.*des_c0)*fR0DES*pow(pow(a,3.)*(1.-om0)+om0,-1.-des_c0)*gsl_sf_hyperg_2F1(des_c0,1.5+des_c0,13./6.+2.*des_c0,(pow(a,3.)*(1.-om0))/(pow(a,3.)*(1.-om0)+om0)))/(2.*gsl_sf_hyperg_2F1(1.+des_c0,1.5+des_c0,13./6.+2.*des_c0,1.-om0))+(pow(a,2.+3.*des_c0)*fR0DES*(2.*pow(a,3.)*(1.-om0)-om0)*pow(pow(a,3.)*(1.-om0)+om0,-2.-des_c0)*gsl_sf_hyperg_2F1(1.+des_c0,1.5+des_c0,13./6.+2.*des_c0,(pow(a,3.)*(1.-om0))/(pow(a,3.)*(1.-om0)+om0)))/(2.*gsl_sf_hyperg_2F1(1.+des_c0,1.5+des_c0,13./6+2.*des_c0,1.-om0)));
	  
	  pvecback[pba->index_bg_F_fR] = 1.; //1 + (pow(a,3.)*fR0DES*pow((pow(a,3.)*(-1 + om0))/(pow(a,3.)*(-1. + om0) - om0),des_c0)*gsl_sf_hyperg_2F1(1. + des_c0,1.5 + des_c0,13./6. +2.*des_c0,(pow(a,3.)*(-1. + om0))/(pow(a,3.)*(-1. + om0) - om0)))/(pow(1. - om0,des_c0)*(-(pow(a,3.)*(-1. + om0)) + om0)*gsl_sf_hyperg_2F1(1. + des_c0,1.5 + des_c0,13./6. + 2.*des_c0,1. - om0));
					      
	  pvecback[pba->index_bg_FR_fR] = 0.; //(pow(3.,2. + des_c0)*fR0DES*pow((pow(a,3.)*(-1. + om0))/(3.*pow(a,3.)*(-1. + om0) - 3.*om0),des_c0)*pow(-(pow(a,3.)*(-1. + om0)) + om0,2.)*((7. + 6.*des_c0)*(pow(a,3.)*(-1. + om0) - om0)*gsl_sf_hyperg_2F1(des_c0,1.5 + des_c0,13./6. + 2.*des_c0,(pow(a,3.)*(-1. + om0))/(pow(a,3.)*(-1. + om0) - om0)) +(2.*pow(a,3.)*(-1. + om0) + om0)*gsl_sf_hyperg_2F1(1. + des_c0,1.5 + des_c0,13./6. + 2.*des_c0, (pow(a,3.)*(-1. + om0))/(pow(a,3.)*(-1. + om0) - om0))))/(2.*pow(a,6.)*pow(1. - om0,des_c0)*om0*pow(3. + 3.*(-1. + pow(a,-3.))*om0,4.)*gsl_sf_hyperg_2F1(1. + des_c0,1.5 + des_c0,13./6. + 2.*des_c0,1. - om0));
      ...
      if (pba->alpha_fR != 0.)
	{
	  pvecback[pba->index_bg_FR_fR] = -((pow(2,5 + pba->alpha_fR)*pow(3,-1 - 2*pba->alpha_fR)*pba->alpha_fR*pow(exp(1.),1 - pow(1.3333333333333333,pba->alpha_fR)*pow((pba->mu2_fR*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,2))/(pow(pba->H0,2)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2)))*((6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4))/(pow(a,8)*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) + (pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))/pow(a,4) + 4*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2))))),pba->alpha_fR))*(-1 + om0 + or0)*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,4)*pow((pba->mu2_fR*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,2))/(pow(pba->H0,2)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2)))*((6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4))/(pow(a,8)*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) + (pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))/pow(a,4) + 4*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2))))),pba->alpha_fR)*(pow(6,pba->alpha_fR) + pow(6,pba->alpha_fR)*pba->alpha_fR - pow(8,pba->alpha_fR)*pba->alpha_fR*pow((pba->mu2_fR*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,2))/(pow(pba->H0,2)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2)))*((6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4))/(pow(a,8)*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) + (pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))/pow(a,4) + 4*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2))))),pba->alpha_fR)))/(pow(pba->H0,2)*pow(-2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) + (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2)),2)*pow((6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4))/(pow(a,8)*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) + (pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))/pow(a,4) + 4*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2))),2))) ;

	  pvecback[pba->index_bg_F_fR] = 1 - (3*pba->alpha_fR*pow(exp(1.),1 - pow(pba->mu2_fR/((3*pba->H0*((pow(a,4)*(6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4)))/pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3) + pow(a,8)*pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))*(pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)) - (pba->alpha_fR*pba->H0*(-1 + om0 + or0)*(-1 - ((pow(pba->H0,2)*pow(3*a*om0 + 4*or0,2))/(4.*pow(a,8)*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) - 2*pow(pba->H0,2)*(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)) + pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4))*((-3*pba->H0*(3*a*om0 + 4*or0))/(2.*pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + (pba->H0*(9*pow(a,2)*pow(om0,2) + 26*a*om0*or0 + 16*pow(or0,2) - 18*pow(a,5)*om0*(-1 + om0 + or0) - 32*pow(a,4)*or0*(-1 + om0 + or0)))/(4.*pow(a,8)*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,1.5))))/pow(-(pba->H0*(3*a*om0 + 4*or0))/(2.*pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + 2*pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)),2) - log(pba->mu2_fR/((-3*pow(pba->H0,2)*(3*a*om0 + 4*or0)*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)))/(pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + 12*pow(pba->H0,2)*(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4))))))/(2.*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)))))/(2.*pow(a,12)*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,1.5)) + 12*pow(pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)) - (pba->alpha_fR*pba->H0*(-1 + om0 + or0)*(-1 - ((pow(pba->H0,2)*pow(3*a*om0 + 4*or0,2))/(4.*pow(a,8)*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) - 2*pow(pba->H0,2)*(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)) + pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4))*((-3*pba->H0*(3*a*om0 + 4*or0))/(2.*pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + (pba->H0*(9*pow(a,2)*pow(om0,2) + 26*a*om0*or0 + 16*pow(or0,2) - 18*pow(a,5)*om0*(-1 + om0 + or0) - 32*pow(a,4)*or0*(-1 + om0 + or0)))/(4.*pow(a,8)*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,1.5))))/pow(-(pba->H0*(3*a*om0 + 4*or0))/(2.*pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + 2*pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)),2) - log(pba->mu2_fR/((-3*pow(pba->H0,2)*(3*a*om0 + 4*or0)*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)))/(pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + 12*pow(pba->H0,2)*(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4))))))/(2.*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4))),2)),pba->alpha_fR))*pow(pba->H0,2)*(1 - om0 - or0)*pow(pba->mu2_fR/((3*pba->H0*((pow(a,4)*(6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4)))/pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3) + pow(a,8)*pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))*(pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)) - (pba->alpha_fR*pba->H0*(-1 + om0 + or0)*(-1 - ((pow(pba->H0,2)*pow(3*a*om0 + 4*or0,2))/(4.*pow(a,8)*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) - 2*pow(pba->H0,2)*(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)) + pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4))*((-3*pba->H0*(3*a*om0 + 4*or0))/(2.*pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + (pba->H0*(9*pow(a,2)*pow(om0,2) + 26*a*om0*or0 + 16*pow(or0,2) - 18*pow(a,5)*om0*(-1 + om0 + or0) - 32*pow(a,4)*or0*(-1 + om0 + or0)))/(4.*pow(a,8)*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,1.5))))/pow(-(pba->H0*(3*a*om0 + 4*or0))/(2.*pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + 2*pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)),2) - log(pba->mu2_fR/((-3*pow(pba->H0,2)*(3*a*om0 + 4*or0)*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)))/(pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + 12*pow(pba->H0,2)*(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4))))))/(2.*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)))))/(4.*pow(a,12)*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,1.5)) + 6*pow(pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)) - (pba->alpha_fR*pba->H0*(-1 + om0 + or0)*(-1 - ((pow(pba->H0,2)*pow(3*a*om0 + 4*or0,2))/(4.*pow(a,8)*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) - 2*pow(pba->H0,2)*(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)) + pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4))*((-3*pba->H0*(3*a*om0 + 4*or0))/(2.*pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + (pba->H0*(9*pow(a,2)*pow(om0,2) + 26*a*om0*or0 + 16*pow(or0,2) - 18*pow(a,5)*om0*(-1 + om0 + or0) - 32*pow(a,4)*or0*(-1 + om0 + or0)))/(4.*pow(a,8)*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,1.5))))/pow(-(pba->H0*(3*a*om0 + 4*or0))/(2.*pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + 2*pba->H0*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)),2) - log(pba->mu2_fR/((-3*pow(pba->H0,2)*(3*a*om0 + 4*or0)*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4)))/(pow(a,4)*sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)) + 12*pow(pba->H0,2)*(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4))))))/(2.*sqrt(1 - om0 + om0/pow(a,3) - or0 + or0/pow(a,4))),2)),1 + pba->alpha_fR))/(pow(2,pba->alpha_fR)*pba->mu2_fR) ;
	  
	  pvecback[pba->index_bg_Fprime_fR] = (pow(2,1 + 2*pba->alpha_fR)*a*pba->alpha_fR*pow(exp(1.),1 - pow(1.3333333333333333,pba->alpha_fR)*pow((pba->mu2_fR*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,2))/(pow(pba->H0,2)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2)))*((6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4))/(pow(a,8)*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) + (pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))/pow(a,4) + 4*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2))))),pba->alpha_fR))*(-1 + om0 + or0)*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,3.5)*pow((pba->mu2_fR*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,2))/(pow(pba->H0,2)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2)))*((6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4))/(pow(a,8)*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) + (pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))/pow(a,4) + 4*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2))))),pba->alpha_fR)*(-1 - pba->alpha_fR + pow(1.3333333333333333,pba->alpha_fR)*pba->alpha_fR*pow((pba->mu2_fR*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,2))/(pow(pba->H0,2)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2)))*((6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4))/(pow(a,8)*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) + (pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))/pow(a,4) + 4*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2))))),pba->alpha_fR))*((pba->H0*pow((pow(a,4)*(6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4)))/pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3) + pow(a,8)*pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))),2))/(pow(a,24)*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,3)) + (8*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2)))*((pba->H0*((pow(a,4)*(6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4)))/pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3) + pow(a,8)*pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,12)*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,1.5)) + (pba->H0*((2*(-(a*om0) - or0 + pow(a,4)*(-1 + om0 + or0))*(-9*pow(a,2)*pow(om0,2) - 26*a*om0*or0 - 16*pow(or0,2) + 18*pow(a,5)*om0*(-1 + om0 + or0) + 32*pow(a,4)*or0*(-1 + om0 + or0)))/pow(a,12) - (pba->alpha_fR*(1 - om0 - or0)*(36*pow(a,2)*pow(om0,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),4)*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) + 36*pow(a,2)*om0*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),5)*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - 288*a*om0*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),4)*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),3) - 192*a*om0*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2)*(3*a*pow(om0,2) + 2*om0*or0 + 6*pow(a,4)*om0*(-1 + om0 + or0) + 16*pow(a,3)*or0*(-1 + om0 + or0)) + 32*a*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*(-om0 + pow(a,3)*(-1 + om0 + or0))*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2)*(9*a*pow(om0,3) + 4*pow(om0,2)*or0 + 108*pow(a,4)*pow(om0,2)*(-1 + om0 + or0) + 136*pow(a,3)*om0*or0*(-1 + om0 + or0) + 72*pow(a,7)*om0*pow(-1 + om0 + or0,2) + 256*pow(a,6)*or0*pow(-1 + om0 + or0,2)) + 4*a*(3*a*om0 + 4*or0)*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)*(-3*pow(a,2)*pow(om0,4) - 11*a*pow(om0,3)*or0 - 8*pow(om0,2)*pow(or0,2) + 171*pow(a,5)*pow(om0,3)*(-1 + om0 + or0) + 384*pow(a,4)*pow(om0,2)*or0*(-1 + om0 + or0) + 208*pow(a,3)*om0*pow(or0,2)*(-1 + om0 + or0) - 360*pow(a,8)*pow(om0,2)*pow(-1 + om0 + or0,2) - 528*pow(a,7)*om0*or0*pow(-1 + om0 + or0,2) - 128*pow(a,6)*pow(or0,2)*pow(-1 + om0 + or0,2) + 192*pow(a,11)*om0*pow(-1 + om0 + or0,3) + 128*pow(a,10)*or0*pow(-1 + om0 + or0,3)) + pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),4)*(9*pow(a,2)*pow(om0,2) + 22*a*om0*or0 + 16*pow(or0,2) + 18*pow(a,5)*om0*(-1 + om0 + or0) + 32*pow(a,4)*or0*(-1 + om0 + or0))*(-9*pow(a,2)*pow(om0,2) - 16*a*om0*or0 - 8*pow(or0,2) - 8*pow(a,4)*or0*(-1 + om0 + or0) + pow(3*a*om0 + 4*or0,2) + pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) - 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) + pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))))/(pow(a,28)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,6))))/(8.*pow(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0,2.5))))/sqrt(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)))/(pow(3,pba->alpha_fR)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2)))*pow((6*pow(a,2)*pow(om0,5) + 14*a*pow(om0,4)*or0 + 8*pow(om0,3)*pow(or0,2) + 3*pow(a,5)*(-26 + 5*pba->alpha_fR)*pow(om0,4)*(-1 + om0 + or0) + 2*pow(a,4)*(-88 + 15*pba->alpha_fR)*pow(om0,3)*or0*(-1 + om0 + or0) + 16*pow(a,3)*(-6 + pba->alpha_fR)*pow(om0,2)*pow(or0,2)*(-1 + om0 + or0) + 18*pow(a,8)*(20 + 13*pba->alpha_fR)*pow(om0,3)*pow(-1 + om0 + or0,2) + 24*pow(a,7)*(32 + 21*pba->alpha_fR)*pow(om0,2)*or0*pow(-1 + om0 + or0,2) + 128*pow(a,6)*(3 + 2*pba->alpha_fR)*om0*pow(or0,2)*pow(-1 + om0 + or0,2) - 24*pow(a,11)*(28 + 27*pba->alpha_fR)*pow(om0,2)*pow(-1 + om0 + or0,3) - 32*pow(a,10)*(40 + 27*pba->alpha_fR)*om0*or0*pow(-1 + om0 + or0,3) - 128*pow(a,9)*(4 + pba->alpha_fR)*pow(or0,2)*pow(-1 + om0 + or0,3) + 96*pow(a,14)*(4 + 5*pba->alpha_fR)*om0*pow(-1 + om0 + or0,4) + 128*pow(a,13)*(4 + 3*pba->alpha_fR)*or0*pow(-1 + om0 + or0,4))/(pow(a,8)*pow(-om0 + 4*pow(a,3)*(-1 + om0 + or0),3)) + (pba->alpha_fR*(-1 + om0 + or0)*(3*a*om0 + 4*or0)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0)))))/pow(a,4) + 4*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0)*(2*(1 + (-1 + pow(a,-3))*om0 + (-1 + pow(a,-4))*or0) - (pba->alpha_fR*(-1 + om0 + or0)*(9*pow(a,2)*pow(om0,2) + 16*a*om0*or0 + 8*pow(or0,2) + 8*pow(a,4)*or0*(-1 + om0 + or0) - pow(3*a*om0 + 4*or0,2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2) + 8*pow(a*om0 + or0 - pow(a,4)*(-1 + om0 + or0),2) - pow(a,2)*pow(om0 - 4*pow(a,3)*(-1 + om0 + or0),2)*log(-(pow(a,3)*pba->mu2_fR)/(3.*pow(pba->H0,2)*(-om0 + 4*pow(a,3)*(-1 + om0 + or0))))))/(pow(a,8)*pow(4 + (-4 + pow(a,-3))*om0 - 4*or0,2))),2)) ;
	}
      else
	{
...
int background_indices(
  ...
  if (pba->Omega0_lambda != 0.)
      ...
      else
	{
	  ...
	  if (pba->log10alpha_fR != -1e2)
	    {
	      pba->alpha_fR=pow(10.,pba->log10alpha_fR);
	      pba->mu2_fR=pow(10.,pba->log10mu2_fR)*pow(pba->H0,2);
	      pba->has_fR = _TRUE_;
	      printf("RUNNING GRANDA'S MODEL WITH WILMAR'S PARAMETRISATION \n");
	    }
	}
    }
  if (pba->Omega0_fld != 0.)
