...
double HG_Approx_30( double a, double c0, double om0, double n ){

  double value = 0;

  value = 1 + (43046721*pow(a,90)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(43 + 2*c0)*(45 + 2*c0)*(47 + 2*c0)*(49 + 2*c0)*(51 + 2*c0)*(53 + 2*c0)*(55 + 2*c0)*(57 + 2*c0)*(59 + 2*c0)*(61 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*(20 + c0 + n)*(21 + c0 + n)*(22 + c0 + n)*(23 + c0 + n)*(24 + c0 + n)*(25 + c0 + n)*(26 + c0 + n)*(27 + c0 + n)*(28 + c0 + n)*(29 + c0 + n)*pow(1 - om0,30))/(5.545778360934203e25*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*(133 + 12*c0)*(139 + 12*c0)*(145 + 12*c0)*(151 + 12*c0)*(157 + 12*c0)*(163 + 12*c0)*(169 + 12*c0)*(175 + 12*c0)*(181 + 12*c0)*(187 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,30)) + (43046721*pow(a,87)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(43 + 2*c0)*(45 + 2*c0)*(47 + 2*c0)*(49 + 2*c0)*(51 + 2*c0)*(53 + 2*c0)*(55 + 2*c0)*(57 + 2*c0)*(59 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*(20 + c0 + n)*(21 + c0 + n)*(22 + c0 + n)*(23 + c0 + n)*(24 + c0 + n)*(25 + c0 + n)*(26 + c0 + n)*(27 + c0 + n)*(28 + c0 + n)*pow(1 - om0,29))/(5.545778360934204e24*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*(133 + 12*c0)*(139 + 12*c0)*(145 + 12*c0)*(151 + 12*c0)*(157 + 12*c0)*(163 + 12*c0)*(169 + 12*c0)*(175 + 12*c0)*(181 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,29)) + (14348907*pow(a,84)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(43 + 2*c0)*(45 + 2*c0)*(47 + 2*c0)*(49 + 2*c0)*(51 + 2*c0)*(53 + 2*c0)*(55 + 2*c0)*(57 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*(20 + c0 + n)*(21 + c0 + n)*(22 + c0 + n)*(23 + c0 + n)*(24 + c0 + n)*(25 + c0 + n)*(26 + c0 + n)*(27 + c0 + n)*pow(1 - om0,28))/(1.9123373658393805e23*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*(133 + 12*c0)*(139 + 12*c0)*(145 + 12*c0)*(151 + 12*c0)*(157 + 12*c0)*(163 + 12*c0)*(169 + 12*c0)*(175 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,28)) + (4782969*pow(a,81)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(43 + 2*c0)*(45 + 2*c0)*(47 + 2*c0)*(49 + 2*c0)*(51 + 2*c0)*(53 + 2*c0)*(55 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*(20 + c0 + n)*(21 + c0 + n)*(22 + c0 + n)*(23 + c0 + n)*(24 + c0 + n)*(25 + c0 + n)*(26 + c0 + n)*pow(1 - om0,27))/(6.829776306569216e21*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*(133 + 12*c0)*(139 + 12*c0)*(145 + 12*c0)*(151 + 12*c0)*(157 + 12*c0)*(163 + 12*c0)*(169 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,27)) + (43046721*pow(a,78)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(43 + 2*c0)*(45 + 2*c0)*(47 + 2*c0)*(49 + 2*c0)*(51 + 2*c0)*(53 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*(20 + c0 + n)*(21 + c0 + n)*(22 + c0 + n)*(23 + c0 + n)*(24 + c0 + n)*(25 + c0 + n)*pow(1 - om0,26))/(6.829776306569216e21*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*(133 + 12*c0)*(139 + 12*c0)*(145 + 12*c0)*(151 + 12*c0)*(157 + 12*c0)*(163 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,26)) + (14348907*pow(a,75)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(43 + 2*c0)*(45 + 2*c0)*(47 + 2*c0)*(49 + 2*c0)*(51 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*(20 + c0 + n)*(21 + c0 + n)*(22 + c0 + n)*(23 + c0 + n)*(24 + c0 + n)*pow(1 - om0,25))/(2.62683704098816e20*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*(133 + 12*c0)*(139 + 12*c0)*(145 + 12*c0)*(151 + 12*c0)*(157 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,25)) + (4782969*pow(a,72)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(43 + 2*c0)*(45 + 2*c0)*(47 + 2*c0)*(49 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*(20 + c0 + n)*(21 + c0 + n)*(22 + c0 + n)*(23 + c0 + n)*pow(1 - om0,24))/(1.050734816395264e19*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*(133 + 12*c0)*(139 + 12*c0)*(145 + 12*c0)*(151 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,24)) + (4782969*pow(a,69)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(43 + 2*c0)*(45 + 2*c0)*(47 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*(20 + c0 + n)*(21 + c0 + n)*(22 + c0 + n)*pow(1 - om0,23))/(1.31341852049408e18*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*(133 + 12*c0)*(139 + 12*c0)*(145 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,23)) + (1594323*pow(a,66)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(43 + 2*c0)*(45 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*(20 + c0 + n)*(21 + c0 + n)*pow(1 - om0,22))/(5.710515306496e16*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*(133 + 12*c0)*(139 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,22)) + (531441*pow(a,63)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(43 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*(20 + c0 + n)*pow(1 - om0,21))/(2.59568877568e15*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*(133 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,21)) + (531441*pow(a,60)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(41 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*(19 + c0 + n)*pow(1 - om0,20))/(3.7081268224e14*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*(127 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,20)) + (177147*pow(a,57)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(39 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*(18 + c0 + n)*pow(1 - om0,19))/(1.8540634112e13*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*(121 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,19)) + (59049*pow(a,54)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(37 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*(17 + c0 + n)*pow(1 - om0,18))/(9.75822848e11*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*(115 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,18)) + (177147*pow(a,51)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(35 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*(16 + c0 + n)*pow(1 - om0,17))/(4.87911424e11*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*(109 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,17)) + (59049*pow(a,48)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(33 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*(15 + c0 + n)*pow(1 - om0,16))/(2.8700672e10*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*(103 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,16)) + (19683*pow(a,45)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(31 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*(14 + c0 + n)*pow(1 - om0,15))/(1.793792e9*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*(97 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,15)) + (19683*pow(a,42)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(29 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*(13 + c0 + n)*pow(1 - om0,14))/(3.587584e8*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*(91 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,14)) + (6561*pow(a,39)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(27 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*(12 + c0 + n)*pow(1 - om0,13))/(2.56256e7*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*(85 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,13)) + (2187*pow(a,36)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(25 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*(11 + c0 + n)*pow(1 - om0,12))/(1.9712e6*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*(79 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,12)) + (2187*pow(a,33)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(23 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*(10 + c0 + n)*pow(1 - om0,11))/(492800.*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*(73 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,11)) + (729*pow(a,30)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(21 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*(9 + c0 + n)*pow(1 - om0,10))/(44800.*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*(67 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,10)) + (243*pow(a,27)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(19 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*(8 + c0 + n)*pow(1 - om0,9))/(4480.*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*(61 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,9)) + (729*pow(a,24)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(17 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*(7 + c0 + n)*pow(1 - om0,8))/(4480.*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*(55 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,8)) + (243*pow(a,21)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(15 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*(6 + c0 + n)*pow(1 - om0,7))/(560.*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*(49 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,7)) + (81*pow(a,18)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(13 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*(5 + c0 + n)*pow(1 - om0,6))/(80.*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*(43 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,6)) + (81*pow(a,15)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(11 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*(4 + c0 + n)*pow(1 - om0,5))/(40.*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*(37 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,5)) + (27*pow(a,12)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(9 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*(3 + c0 + n)*pow(1 - om0,4))/(8.*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*(31 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,4)) + (9*pow(a,9)*(3 + 2*c0)*(5 + 2*c0)*(7 + 2*c0)*(c0 + n)*(1 + c0 + n)*(2 + c0 + n)*pow(1 - om0,3))/(2.*(13 + 12*c0)*(19 + 12*c0)*(25 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,3)) + (9*pow(a,6)*(3 + 2*c0)*(5 + 2*c0)*(c0 + n)*(1 + c0 + n)*pow(1 - om0,2))/(2.*(13 + 12*c0)*(19 + 12*c0)*pow(pow(a,3)*(1 - om0) + om0,2)) + (3*pow(a,3)*(3 + 2*c0)*(c0 + n)*(1 - om0))/((13 + 12*c0)*(pow(a,3)*(1 - om0) + om0));
  ...
  if (pba->has_fR == _TRUE_) 
    {
      if (pba->b_pi != 0.)
	{
	  pvecback[pba->index_bg_Fprime_fR] = ((pow(a,2.+3.*des_c0)*(7.+6.*des_c0)*fR0DES*pow(pow(a,3.)*(1.-om0)+om0,-1.-des_c0)*HG_Approx_30(a,des_c0,om0,0))/(2.*HG_Approx_30(1.,des_c0,om0,1))+(pow(a,2.+3.*des_c0)*fR0DES*(2.*pow(a,3.)*(1.-om0)-om0)*pow(pow(a,3.)*(1.-om0)+om0,-2.-des_c0)*HG_Approx_30(a,des_c0,om0,1))/(2.*HG_Approx_30(1,des_c0,om0,1)));
	  
	  pvecback[pba->index_bg_F_fR] = 1 + (pow(a,3.)*fR0DES*pow((pow(a,3.)*(-1 + om0))/(pow(a,3.)*(-1. + om0) - om0),des_c0)*HG_Approx_30(a,des_c0,om0,1))/(pow(1. - om0,des_c0)*(-(pow(a,3.)*(-1. + om0)) + om0)*HG_Approx_30(1.,des_c0,om0,1));

	  pvecback[pba->index_bg_FR_fR] = (pow(3.,2. + des_c0)*fR0DES*pow((pow(a,3.)*(-1. + om0))/(3.*pow(a,3.)*(-1. + om0) - 3.*om0),des_c0)*pow(-(pow(a,3.)*(-1. + om0)) + om0,2.)*((7. + 6.*des_c0)*(pow(a,3.)*(-1. + om0) - om0)*HG_Approx_30(a,des_c0,om0,1)+(2.*pow(a,3.)*(-1. + om0) + om0)*HG_Approx_30(a,des_c0,om0,1)))/(2.*pow(a,6.)*pow(1. - om0,des_c0)*om0*pow(3. + 3.*(-1. + pow(a,-3.))*om0,4.)*HG_Approx_30(1,des_c0,om0,1));
	}
      else
	{
...
int background_indices(
  ...
  if (pba->Omega0_lambda != 0.)
	...
	{
	  printf("ONE CAN ONLY GIVE log10b_pi OR bhs \n");
	  exit(1);
	}
      else
	{
